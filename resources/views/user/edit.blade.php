        ...
        <div class="col-md-9">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('user.update', Auth::user()->slug) }}">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
                        ...
                        <div class="form-group{{ $errors->has('slug') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="slug" type="text" class="form-control" name="slug" value="{{ old('slug') ? old('slug') : $user->slug }}" required autofocus>
